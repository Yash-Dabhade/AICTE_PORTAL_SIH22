...
import { saveNewReport } from "../../utils/dbHelper";
import "react-toastify/dist/ReactToastify.css";

export default function NewReport({ btnFunc }) {
  function handleSubmit(e) {
    e.preventDefault();
    let name = document.getElementById("reportName").value;
    saveNewReport(name, btnFunc);
  }
