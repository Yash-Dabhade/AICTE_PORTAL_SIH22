...
export default function InstituteCourses() {
    ...
    function getValues(){
    let Title = document.getElementById("addCource").value;
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-white-200">
            ...
            <div className="py-6 px-6 lg:px-8">
                ...
                <form className="space-y-6" action="#">
                    ...
                    <div>
                        <label htmlFor="addCource" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black-900">Title*</label>
                        <input type="addCource" name="addCource" id="addCource" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black-100 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black" placeholder="Electronics, MIC" required=""/>
                    </div>


                    <div>
                        <label htmlFor="courceCode" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black-900">Code*</label>
                        <input   name="courceCode" id="courceCode" placeholder="22617, 22619" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black"/>
                    </div>


                    <div className='mt-6'>
                    <label className=''>Select Level</label>
                    <select className='ml-36' name="level" id="level" value="Select Level">
